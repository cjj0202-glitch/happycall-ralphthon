...
function Scene({ caseData, onBack, onLinkEvidence }: Props) {
  ...
  async function link(id: string) {
    ...
    catch (failure) { if (mounted.current) setError(failure instanceof Error ? failure.message : '연결 실패. 잠시 후 다시 시도하세요.'); }
