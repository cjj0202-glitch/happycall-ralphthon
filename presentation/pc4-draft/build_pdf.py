...
text('v3 부모 흐름·수정 CCTV의 새 UI 검수, 사람 청취·사용성 검증이 남았습니다.\n장애 시 기존 증거와 미확인 안내로 전환합니다. 공식 제출은 별도입니다.',64,512,1152,20)
footer(5,'04:15-05:00','근거 M3·P3·M6·M7·M8: prototype-independent-acceptance, pc4 Q3, pc2-pause-adoption, CCTV·배포 보고. 고정 문서 기준이며 최종 인수는 pc1입니다.')
c.save()
