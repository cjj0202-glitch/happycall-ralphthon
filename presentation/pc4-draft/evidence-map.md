...
M8은 pc2의 별도18/18 격리 재생과 pc1의27/27 증거 대조, v3 자산3/3·ASGI4/4를 구분합니다. CASE-0002에0.20초 쉼을 넣어49.55초에서49.75초로 바뀌었습니다. 새 부모 빌드 전체 흐름 완료는 M8 자료 기준에서 미확인이고, M8 작성 당시 사람 청취는 0회였습니다. 이후 [M9]의 메인 전달로 사용자 부정 청취 피드백 1건이 추가됐습니다. 체계적 청취 평가는 미완료입니다. 과거v2의6/6을 v3 최신 전체흐름 통과로 쓰지 않습니다.
...
[메인 댓글][M9]은 기존 v3 한국어 통화가 어색하다는 사용자 부정 청취 피드백 **1건**을 전달했습니다. 22:19 KST는 메인 전달 시각이며 실제 청취 시각은 특정하지 않습니다. 이 PC가 직접 청취한 결과, 네 사람 합의, 통계 평가 또는 MOS 점수가 아닙니다. 기존 재생·전사·오류 복구 기술 검사의 분모는 그대로 보존하며 자연스러움 품질 통과로 해석하지 않습니다.

메인에 따르면 v4 대본 후보와 별도의 한국어 품질 기준을 준비 중이나, 전체 새 음원 합성·STT·제품 교체는 미완료입니다. 공급자·음성 이름이나 내부 수용 기준은 실제 품질 점수가 아닙니다. pc4는 대본·음원 중복 제작과 제품 교체를 시작하지 않았습니다. 이 후속 정보는 고정 e1ef36f/d784171 증거를 덮어쓰지 않으며, [후속 입력 기록](feedback-input.json)에 전달자·시각·댓글 본문 해시를 기록했습니다.

[M9]: https://github.com/cjj0202-glitch/happycall-ralphthon/issues/10#issuecomment-5761145013
