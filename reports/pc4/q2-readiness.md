...
첫 공유 커밋 `608059525ef0b04eafe054985319c45a6b3fc5c9`의 Git blob 대조에서 검사기 CRLF→LF 변환을 발견했습니다. 당시 로컬 실행 해시는 `cb533e59e2db918e6385f9ccecb250e88c7eba127dddd7b41002af642a6bfa97`이며 Git의 LF 해시는 `b64bf8e028f187829acdca3f243e37e382996b4f6e99e45cd4ca4c14d19a845e`입니다. 내용 차이가 CRLF뿐임을 바이트 비교하고, 소유 폴더의 `.gitattributes`로 해당 파일만 LF로 고정한 후 자체 검사를 다시 실행했습니다. 현재 자체검사 JSON과 노트는 실제 LF 파일 재실행의 해시를 기록하며 첫 관측은 위 커밋에 보존했습니다.
