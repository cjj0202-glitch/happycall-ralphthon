        ...
        try:
            ...
            completion = client.chat.completions.create(
                ...
                messages=[{"role": "system", "content": (
                    ...
                    "subject는 짧게 쓰되 대상의 핵심 불확실성과 원문에 명시된 현재 업무 단계를 빠뜨리지 마라. "
                    "최초·재문의·처리 단계가 원문에 명시되지 않았으면 추정해 붙이지 않는다. 점포 귀속의 미확인과 문의한 점포의 신원 미확인을 구분한다. "
                    ...
                    "인용은 연속된 한 구간만 사용하며 떨어진 문장을 줄임표로 연결하거나 글자를 생략하지 않는다. "
